...
public class ARGCountTimePermission extends ArgumentModule
{
	...
	public ARGCountTimePermission(AfkR plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException
	{
		...
		new BukkitRunnable()
		{
			...
			public void run()
			{
				...
				{
					final PluginUser user = (PluginUser) plugin.getMysqlHandler().getData(MysqlType.PLUGINUSER, "`player_uuid` = ?", uuid);
					if(user == null)
					{
						continue;
					}
